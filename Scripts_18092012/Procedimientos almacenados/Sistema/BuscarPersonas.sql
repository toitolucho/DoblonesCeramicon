...
SET @S = 'SELECT P.DIPersona, dbo.ObtenerNombreCompleto(P.DIPersona) AS NombreCompleto, P.Paterno, P.Materno, P.Nombres, P.Sexo, P.Celular, P.EMail, P.DireccionD, P.TelefonoD'
...
ELSE IF @CodigoAmbitoBusqueda = '5'
	SET @W = 'WHERE P.Celular ' + @OperadorComparacion + @TextoABuscarOptimizado
ELSE IF @CodigoAmbitoBusqueda = '6'
	SET @W = 'WHERE P.Email ' + @OperadorComparacion + @TextoABuscarOptimizado
ELSE IF @CodigoAmbitoBusqueda = '7'
	SET @W = 'WHERE P.DireccionD ' + @OperadorComparacion + @TextoABuscarOptimizado
ELSE IF @CodigoAmbitoBusqueda = '8'
	SET @W = 'WHERE P.TelefonoD ' + @OperadorComparacion + @TextoABuscarOptimizado
ELSE
	SET @W = ' '
