...
( 
	...
	BEGIN
		...
		BEGIN
			...
			AND InventariosProductos.CodigoProducto = PC.CodigoProductoComponente
		END
		...
		BEGIN
			...
			BEGIN
				...
				--LOGICA GENERAL PARA TODOS LOS PRODUCTOS
				--UPDATE InventariosProductos
	...
	--PARA FORMULA
	UPDATE InventariosProductos
	SET PrecioUnitarioVenta1 = ROUND(CPD.PrecioUnitarioCompra + CPD.PrecioUnitarioCompra / (1 - (P.RendimientoDeseado1 / 100)) , 2),
		PrecioUnitarioVenta2 = ROUND(CPD.PrecioUnitarioCompra + CPD.PrecioUnitarioCompra / (1 - (P.RendimientoDeseado2 / 100)) , 2),
		PrecioUnitarioVenta3 = ROUND(CPD.PrecioUnitarioCompra + CPD.PrecioUnitarioCompra / (1 - (P.RendimientoDeseado3 / 100)) , 2),
		PrecioUnitarioVenta4 = ROUND(CPD.PrecioUnitarioCompra + CPD.PrecioUnitarioCompra / (1 - (P.RendimientoDeseado1 / 100))  + (CPD.PrecioUnitarioCompra + CPD.PrecioUnitarioCompra / (1 - (P.RendimientoDeseado1 / 100))) * @PorcentajeImpuestoIVA /100 , 2),
		PrecioUnitarioVenta5 = ROUND(CPD.PrecioUnitarioCompra + CPD.PrecioUnitarioCompra / (1 - (P.RendimientoDeseado2 / 100))  + (CPD.PrecioUnitarioCompra + CPD.PrecioUnitarioCompra / (1 - (P.RendimientoDeseado2 / 100))) * @PorcentajeImpuestoIVA /100 , 2),
		PrecioUnitarioVenta6 = ROUND(CPD.PrecioUnitarioCompra + CPD.PrecioUnitarioCompra / (1 - (P.RendimientoDeseado3 / 100))  + (CPD.PrecioUnitarioCompra + CPD.PrecioUnitarioCompra / (1 - (P.RendimientoDeseado3 / 100))) * @PorcentajeImpuestoIVA /100 , 2),
		PrecioValoradoTotal = ISNULL(PrecioValoradoTotal,0) + (@CantidadRecepcion * CPD.PrecioUnitarioCompra),
		PrecioUnitarioCompra = CPD.PrecioUnitarioCompra
	...
	--UPDATE PRODUCTOS SET RendimientoDeseado1 = 0, RendimientoDeseado2 = 0, RendimientoDeseado3 = 0
