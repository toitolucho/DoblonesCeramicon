...
DROP TABLE ProductosCompuestos
GO
...
RendimientoDeseado1			DECIMAL(10, 2)	NOT NULL DEFAULT 0.00,
RendimientoDeseado2			DECIMAL(10, 2)	NOT NULL DEFAULT 0.00,
RendimientoDeseado3			DECIMAL(10, 2)	NOT NULL DEFAULT 0.00,
...
--RutaArchivoImagen			TEXT			NOT NULL,
...
(
CodigoProducto					CHAR(15)		NOT NULL REFERENCES Productos (CodigoProducto),
CodigoProductoComponente		CHAR(15)		NOT NULL REFERENCES Productos (CodigoProducto),
NumeroComponente				INT				NULL,
Cantidad						INT				NULL,
PRIMARY KEY(CodigoProducto, CodigoProductoComponente)
...
CodigoTipoCredito			CHAR(1)			NOT NULL DEFAULT 'T' CHECK (CodigoTipoCredito IN ('L', 'T', 'P')),--'L'->LibreDisponibilidad, 'T'->'Por monto total venta productos, 'P'->Por monto parcial venta productos;
NumeroAgenciaCotizacion		INT				NULL,
NumeroCotizacion			INT				NULL,
CodigoSistemaAmortizacion	CHAR(1)			NOT NULL CHECK (CodigoSistemaAmortizacion IN ('A', 'F')), 
...
InteresAnual				DECIMAL(10,2)	NOT NULL,
InteresAnualMora			DECIMAL(10,2)	NULL,
...
NumeroAgenciaSolicitud		INT				NOT NULL REFERENCES Agencias(NumeroAgencia),
CodigoUsuarioSolicitud		INT				NOT NULL REFERENCES Usuarios(CodigoUsuario),
FechaHoraSolicitud			DATETIME		NOT NULL,
NumeroAgenciaAutorizacion	INT				NULL REFERENCES Agencias(NumeroAgencia),
CodigoUsuarioAutorizacion	INT				NULL REFERENCES Usuarios(CodigoUsuario),
FechaHoraAutorizacion		DATETIME		NULL DEFAULT GETDATE(),
CodigoAutorizacion			CHAR(10)		NULL,
CodigoEstadoCredito			CHAR(1)			NOT NULL CHECK(CodigoEstadoCredito IN ('S', 'A', 'R', 'P')) --'S'->Solicitado, 'A'->Autorizado, 'R'->Rechazado, 'P'->Pagado
--FOREIGN KEY (NumeroAgenciaCotizacion, NumeroCotizacion) REFERENCES CotizacionVentasProductos(NumeroAgencia, NumeroCotizacionVentaProducto)
)
GO
...
CuotaAmortizacion			DECIMAL(10, 2)	NOT NULL,
CuotaInteres				DECIMAL(10, 2)	NOT NULL,
TotalAmortizado				DECIMAL(10, 2)	NOT NULL,
SaldoAdeudado				DECIMAL(10, 2)	NOT NULL,
...
Observaciones					TEXT			NULL,
PRIMARY KEY (NumeroAgencia, NumeroVentaProducto),
FOREIGN KEY(NumeroAgencia, NumeroFactura) REFERENCES VentasFacturas(NumeroAgencia, NumeroFactura)
)
GO
...
FechaHoraEnvioPadre				DATETIME		NULL
