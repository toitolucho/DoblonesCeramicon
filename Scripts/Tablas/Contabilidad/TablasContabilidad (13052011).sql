...
DROP TABLE ConfiguracionesCuentasDetalle
GO
...
(
	...
	CodigoTipoTransaccion		CHAR(1)			NOT NULL CHECK(CodigoTipoTransaccion IN ('V','C','T')), --'V':VENTAS, 'C':COMPRAS, 'T':TRANSFERENCIAS [todas las transacciones de gestion comercial(ventas, devoluciones por ventas, compras, etc) ]
	CodigoTipoMovimiento		CHAR(1)			NOT NULL CHECK(CodigoTipoMovimiento IN ('I','E','T')),
	DescripcionConfiguracion	TEXT			NULL	
)
GO

CREATE TABLE ConfiguracionesCuentasDetalle
(
	...
	PorcentajeMontoTotalDH		DECIMAL(10,2)	NOT NULL CHECK (PorcentajeMontoTotalDH > 0 AND PorcentajeMontoTotalDH <=100),
...
GO
--exec ListarCuentasPorPagarBusquedaNumCtaXPagar '14'
--exec ListarCuentasPorPagarBusqueda '','01/01/2011','15/05/2011','P','P'
