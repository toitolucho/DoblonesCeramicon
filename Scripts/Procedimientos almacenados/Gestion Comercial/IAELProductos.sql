...
BEGIN
	...
	BEGIN
		INSERT INTO dbo.Productos (CodigoProducto,CodigoProductoFabricante, NombreProducto,NombreProducto1, NombreProducto2,CodigoMarcaProducto, CodigoTipoProducto,CodigoUnidad, CodigoTipoCalculoInventario,LlenarCodigoPE, ProductoTangible,ProductoSimple, CalcularPrecioVenta, RendimientoDeseado1, RendimientoDeseado2, RendimientoDeseado3, Descripcion, Observaciones)					
		VALUES (@CodigoProducto,@CodigoProductoFabricante, @NombreProducto,@NombreProducto1, @NombreProducto2,@CodigoMarcaProducto, @CodigoTipoProducto,@CodigoUnidad, @CodigoTipoCalculoInventario,@LlenarCodigoPE, @ProductoTangible,@ProductoSimple, @CalcularPrecioVenta, @RendimientoDeseado1, @RendimientoDeseado2, @RendimientoDeseado3, @Descripcion, @Observaciones)
...
BEGIN
	...
	IF(NOT EXISTS (SELECT * FROM Productos WHERE NombreProducto = @NombreProducto AND CodigoProducto <> @CodigoProducto))
		...
		SET		
			...
			RendimientoDeseado1			= @RendimientoDeseado1,
			RendimientoDeseado2			= @RendimientoDeseado2,
			RendimientoDeseado3			= @RendimientoDeseado3,
...
BEGIN
	...
	SELECT P.CodigoProducto, P.CodigoProductoFabricante, P.NombreProducto, P.NombreProducto1, P.NombreProducto2, P.CodigoMarcaProducto, P.CodigoTipoProducto, P.CodigoUnidad, P.CodigoTipoCalculoInventario, P.LlenarCodigoPE, P.ProductoTangible, P.ProductoSimple, P.CalcularPrecioVenta, P.RendimientoDeseado1, P.RendimientoDeseado2, P.RendimientoDeseado3, P.Descripcion, P.Observaciones
