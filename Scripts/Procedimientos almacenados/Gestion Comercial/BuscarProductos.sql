...
SET @S = 'SELECT Pr.CodigoProducto, Pr.CodigoProductoFabricante, Pr.NombreProducto, PR.NombreProducto1, Pr.NombreProducto2, Pr.CodigoMarcaProducto, PR.CodigoTipoProducto, Pr.CodigoUnidad, Pr.CodigoTipoCalculoInventario, Pr.LlenarCodigoPE, Pr.ProductoTangible, Pr.ProductoSimple, Pr.CalcularPrecioVenta, Pr.RendimientoDeseado1, Pr.RendimientoDeseado2, Pr.RendimientoDeseado3, Pr.Descripcion, Pr.Observaciones'
