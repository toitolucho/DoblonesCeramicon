...
DROP PROCEDURE CopiarProductosComponentes
GO

CREATE PROCEDURE CopiarProductosComponentes
@CodigoProductoOrigen	CHAR(15),
@CodigoProductoDestino	CHAR(15)
AS
BEGIN
	INSERT INTO ProductosCompuestos
	SELECT @CodigoProductoDestino, CodigoProductoComponente, NumeroComponente, Cantidad
	FROM ProductosCompuestos
	WHERE CodigoProducto = @CodigoProductoOrigen
END
GO