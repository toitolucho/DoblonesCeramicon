...
namespace WFADoblones20.ReportesContabilidad {
    ...
    public class CRCuentasPorPagar : ReportClass {
        
        public CRCuentasPorPagar() {
        }
        
        public override string ResourceName {
            get {
                return "CRCuentasPorPagar.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "WFADoblones20.ReportesContabilidad.CRCuentasPorPagar.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCRCuentasPorPagar : Component, ICachedReport {
        
        public CachedCRCuentasPorPagar() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CRCuentasPorPagar rpt = new CRCuentasPorPagar();
            rpt.Site = this.Site;
            return rpt;
        }
