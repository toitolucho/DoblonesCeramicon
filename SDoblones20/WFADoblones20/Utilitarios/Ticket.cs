...
namespace WFADoblones20.Utilitarios
{
    public class Ticket
    {
        ...
        public static void verEjemplo()
        {
            ...
            ticket.AddFooterLine("EL CAFE ES NUESTRA PASION...BY TOITOS" ); 
            ...
            ticket.PrintTicket("HP Deskjet D2400 series"); 
        }
    }
