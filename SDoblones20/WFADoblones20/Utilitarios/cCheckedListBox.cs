...
namespace WFADoblones20.Utilitarios
{
    /// <summary>
    /// (eraghi)
    /// Personaliza el CheckedListBox con la facibilidad de enganchar un binding (Value property)
    /// </summary>
    ...
    public class cCheckedListBox : CheckedListBox
    {
        ...
        /// <summary>
        ///    Retorna o Envia la propiedad para desplegar para el Control CustomControls.CheckedListBox.
        ///
        /// Returns:
