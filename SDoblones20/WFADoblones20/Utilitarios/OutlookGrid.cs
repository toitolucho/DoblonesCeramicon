...
namespace OutlookStyleControls
{
    ...
    {
        private Font fuenteDefecto = new Font("Microsoft Sans Serif", 8.25f, FontStyle.Bold);
            ...
            else
            {
                ...
                foreach (DataSourceRow r in list)
                {
                    ...
                    else // item is not part of the group, so create new group
                    {
                        ...
                        //row.Cells[0].Style.Font = new Font(fuenteDefecto.Name, fuenteDefecto.Size, FontStyle.Bold);
                        ...
                        //this Cells[0].Style.Font = new Font(fuenteDefecto.Name, fuenteDefecto.Size, FontStyle.Bold);
                    }
                ...
                //foreach (OutlookGridRow fila in this.Rows)
                //{
                //    if (fila.IsGroupRow)
                //    {
                //        fila.DefaultCellStyle.BackColor = Color.Violet;
                //        fila.Cells[0].Style.Font = new Font(fuenteDefecto.Name, fuenteDefecto.Size, FontStyle.Bold);
                //    }
                //}
            }
