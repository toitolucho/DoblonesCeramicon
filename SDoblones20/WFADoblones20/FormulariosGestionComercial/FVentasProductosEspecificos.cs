...
{
    public partial class FVentaProductosEspecificos : Form
    {
        ...
        public DSDoblones20GestionComercial2.ListarCodigosProductosEspecificosDataTable DTProductosEspecificos;
        public DataTable DTProductosEspecificosSeleccionados = null;


        public FVentaProductosEspecificos(int NumeroAgencia, int NumeroTransferenciaProducto, string CodigoProducto, string CodigoTipoEnvioRecepcion, string NombreProducto, int CantidadSeleccionada)
        {
            InitializeComponent();
            ...
            DTProductosEspecificos = new DSDoblones20GestionComercial2.ListarCodigosProductosEspecificosDataTable();
            DTProductosEspecificos = _VentasProductosEspecificosCLN.ListarCodigosProductosEspecificos(NumeroAgencia, NumeroTransferenciaProducto, CodigoProducto, CodigoTipoEnvioRecepcion);
        ...
        private void checkSeleccionarTodo_CheckedChanged(object sender, EventArgs e)
        {
            if (checkSeleccionarTodo.Checked)
            {
                ...
                {
                    foreach (DSDoblones20GestionComercial2.ListarCodigosProductosEspecificosRow DRProductoEspecifico in DTProductosEspecificos.Rows)
                    {
            ...
            else
            {
                ...
                foreach (DSDoblones20GestionComercial2.ListarCodigosProductosEspecificosRow DRProductoEspecifico in DTProductosEspecificos.Select("Seleccionar = true"))
                {
                    DRProductoEspecifico.Seleccionar = false;
                }
            }
        ...
        private void btnIngresarSeleccionar_Click(object sender, EventArgs e)
        {
            ...
            if (!String.IsNullOrEmpty(txtBoxCodEspecifico.Text.Trim()))
            {
                ...
                DSDoblones20GestionComercial2.ListarCodigosProductosEspecificosRow DRCodigoProductoEspecifico = DTProductosEspecificos.FindByCodigoProductoEspecifico(CodigoProductoEspecifico);
        ...
        public void cargarDatosAnterior(DSDoblones20GestionComercial2.DTProductosRecepcionEntregaEspecificosDataTable
            DTProductosEspecificosAnteriores)
        {
            checkSeleccionarTodo.Checked = false;
            foreach (DSDoblones20GestionComercial2.DTProductosRecepcionEntregaEspecificosRow
                DRProductoEspecifico in DTProductosEspecificosAnteriores.Select("CodigoProducto ='" +CodigoProducto +"'" ))
            {
                this.DTProductosEspecificos.FindByCodigoProductoEspecifico(DRProductoEspecifico.CodigoProductoEspecifico).Seleccionar = true;
            }
        }
    }
}
